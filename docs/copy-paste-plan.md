...
- [ ] Добавить визуальную индикацию скопированного тайла
- [ ] Добавить поддержку копирования зданий
- [ ] Добавить поддержку множественного выделения (будущее)
- [ ] Добавить отмену/повтор (undo/redo) для операций копирования/вставки
